...
@Component({
  selector: 'app-reto-del-elemento',
  templateUrl: './reto-del-elemento.component.html',
  styleUrls: ['./reto-del-elemento.component.scss'],
})
export class RetoDelElementoComponent implements OnInit, OnDestroy {
  ...
  manageData = async () => {
    ...
    console.log(`Questions received: ${this.questions.length}`)
  ...
  async finishChallenge() {
    ...
    try{
      ...
      console.log("There was an error updating stats", err);
    }
  }
