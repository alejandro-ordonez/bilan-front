...
@Component({
  selector: 'app-reto-del-trabajo',
  templateUrl: './reto-del-trabajo.component.html',
  styleUrls: ['./reto-del-trabajo.component.scss'],
})
export class RetoDelTrabajoComponent implements OnInit, OnDestroy {
