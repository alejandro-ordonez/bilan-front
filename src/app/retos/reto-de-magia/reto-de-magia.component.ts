...
@Component({
  selector: 'app-reto-de-magia',
  templateUrl: './reto-de-magia.component.html',
  styleUrls: ['./reto-de-magia.component.scss'],
})
export class RetoDeMagiaComponent implements OnInit, OnDestroy {
