...
@Component({
  selector: 'app-reto-de-planeacion',
  templateUrl: './reto-de-planeacion.component.html',
  styleUrls: ['./reto-de-planeacion.component.scss'],
})
export class RetoDePlaneacionComponent implements OnInit, OnDestroy {
